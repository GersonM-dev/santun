...
@section('content')
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <button id="openEditBtn"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 opacity-90" viewBox="0 0 24 24" fill="currentColor">
                    <path
                        d="M4 21h4l11-11-4-4L4 17v4Zm15.7-12.3a1 1 0 0 0 0-1.4l-3-3a1 1 0 0 0-1.4 0L13 3.9l4.1 4.1 2.6-2.6Z" />
                </svg>
                Edit Profil
            </button>
        </div>
    ...
    {{-- =================== MODAL EDIT PROFIL =================== --}}
    <div id="editModal" class="fixed inset-0 z-[100] hidden flex items-center justify-center bg-black/50 p-4" role="dialog"
        aria-modal="true" aria-hidden="true">
        <div class="w-full max-w-lg sm:max-w-xl rounded-xl bg-white shadow-2xl flex flex-col max-h-[90vh]">
            <!-- Header (sticky) -->
