        ...
        <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
                            ...
                            <div class="mt-6 space-y-4">
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-gray-500">Pendaftaran layanan bantuan kesehatan jiwa
                                            (ODGJ),
            ...
            <div class="mt-10 grid items-start gap-10 lg:grid-cols-2">
                ...
                <div class="flex justify-center lg:justify-end">
                    @if($struktur)
                        <h2 class="text-3xl font-bold text-gray-900 sm:text-4xl">Struktur Organisasi</h2>
