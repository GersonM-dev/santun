...
@section('content')
   ...
   <div id="donationModal" class="fixed inset-0 z-50 flex items-center justify-center hidden bg-gray-900/20 backdrop-blur-sm">
    ...
    <div class="bg-white py-8">
        <div class="mx-auto max-w-3xl p-4 md:p-8 rounded-xl shadow-xl/30">
